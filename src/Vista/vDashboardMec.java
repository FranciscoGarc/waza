 ...
 * @author Fran
 */
public class vDashboardMec extends javax.swing.JFrame {
    int xMouse, yMouse;
    /**
     * Creates new form vDashboardMec
     */
    public vDashboardMec() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vDashboardMec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vDashboardMec().setVisible(true);
            }
        });
    }
