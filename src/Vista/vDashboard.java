...
int xMouse, yMouse;
    ...
    private void initComponents() {
        ...
        kButton10.setkBackGroundColor(new java.awt.Color(0, 102, 51));
        kButton10.setkEndColor(new java.awt.Color(51, 204, 0));
        kButton10.setkForeGround(new java.awt.Color(0, 0, 0));
        kButton10.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        kButton10.setkHoverStartColor(new java.awt.Color(0, 204, 51));
